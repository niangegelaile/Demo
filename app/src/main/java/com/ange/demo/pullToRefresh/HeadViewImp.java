...
public class HeadViewImp extends HeadView{
    private View view;
    private ImageView ivRocket;
    private AnimationDrawable mAnimation;
    public HeadViewImp(@NonNull Context context) {
        this(context,null);
    }

    public HeadViewImp(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
